...
function expandArticleBody() {
  var articleButtons = document.querySelectorAll('.expand_button');
  Array.from(articleButtons).map(function (button) {
...
function highlightArticle() {
  var highlightButtons = document.querySelectorAll('.highlightBtn');
  Array.from(highlightButtons).map(function (hb) {
